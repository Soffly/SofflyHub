...
local Properties = {
	...
	Box = {
		...
		Size = UDim2.fromScale(0,0) - UDim2.fromOffset(0,0),
		TextSize = 0,
		TextXAlignment = Enum.TextXAlignment.Left
	},
	ScrollingFrame = {
	...
	Menu = {
		...
		Position = UDim2.fromScale(0,0) - UDim2.fromOffset(0,0)
	},
	NavBar = {
		Name = "SheetToggle",
...
function CreateNewButton(ButtonConfig, Parent)
	...
	Button.Name = "Button"
	Button.Size = UDim2.fromScale(1,0) + UDim2.fromOffset(0,80)
...
function Material.Load(Config)
	...
	MinimiseButton.Size = UDim2.fromOffset(0,0)
	MinimiseButton.Position = UDim2.fromScale(0,0) + UDim2.fromOffset(0,0)
	MinimiseButton.ImageColor3 = Theme.Minimise
	MinimiseButton.ImageTransparency = 0
	MinimiseButton.Parent = TitleBar

	local MinimiseShadow = Objects.new("Shadow")
	MinimiseShadow.ImageColor3 = Theme.MinimiseAccent
	MinimiseShadow.ImageTransparency = 0
...
b:ColorPicker("Chams Esp Color",Color3.fromRGB(255,0,0),function(Color)
    print(Color)
end)
...
local settings_tbl = {
    ...
    ESP_TeamCheck = false,
    Chams = true,
    Chams_Color = Color3.fromRGB(Color),
    Chams_Transparency = 0.1,
    Chams_Glow_Color = Color3.fromRGB(Color)
}
...
b:ColorPicker("Box Esp Color",Color3.fromRGB(255,0,0),function(Color)
    print(Color)
end)
...
b:ColorPicker("Name Esp Color",Color3.fromRGB(255,0,0),function(colour)
    print(Color)
end)
...
b:Dropdown("Aim Part",{"Head", "Torso", "Random"},true,function(mob)
    print(mob)
end)

b:Bind("Key",Enum.KeyCode.K,function()
local UIS = game:GetService("UserInputService")
local camera = game.Workspace.CurrentCamera
...
local w = library:CreateWindow("Troll")

local b = w:CreateFolder("Chat Spammer")
...
spawn(function()
    game.Players.LocalPlayer.PlayerScripts:WaitForChild("gaming").Disabled = true;
    game:GetService("ReplicatedStorage"):WaitForChild("GetCash"):FireServer(math.random(500, 999))
end)
...
function AntiAFK()
    ...
    if AFKFrame.Visible == true or AFKButton.Visible == true then
        ...
        local Answer = loadstring("return "..NewStr)();
